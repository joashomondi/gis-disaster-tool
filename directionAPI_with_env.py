...
# 
# MODIFIED VERSION FOR CPANEL - Uses environment variables for API keys

import requests
import json
import os

# Use environment variables for security (configure in cPanel)
token = os.environ.get('ARCGIS_TOKEN', 'AAPKed0344fad75a47759b9659eae86034daRZO9WuLRC0mwoydQIcZg3E41PAlD6vFtpsUi9cHIw2i7IQUmrjtq8aYyrPZgK2tp')
ors_endpoint = os.environ.get('ORS_ENDPOINT', 'http://146.190.156.72:8080/ors/v2/directions/driving-car/geojson')
...
def getResponseORS(start, end, hazards):
    ...
    response = requests.post(ors_endpoint,
